        ...
        <footer className="py-20 border-t border-white/5 relative z-10 bg-[#05070A]">
            <div className="max-w-7xl mx-auto px-6">
                <div className="grid md:grid-cols-4 gap-12 mb-20">
                    <div className="col-span-2">
                        <div className="flex items-center gap-2 mb-6">
                            <div className="w-6 h-6 bg-gradient-to-tr from-emerald-500 to-blue-600 rounded shadow-lg" />
                            <span className="font-black tracking-tighter text-lg text-white">IC ORIGIN</span>
                        </div>
                        <p className="text-slate-500 text-sm max-w-xs leading-relaxed">
                            Institutional-grade market intelligence infrastructure for the modern enterprise.
                        </p>
                    </div>
                ...
                <div className="flex flex-col md:flex-row justify-between items-center pt-10 border-t border-white/5 gap-6 saturate-0 opacity-40 hover:saturate-100 hover:opacity-100 transition-all duration-700">
                    <p className="text-[10px] font-mono tracking-tighter">© 2026 IC ORIGIN // SYSTEM_STATUS=ACTIVE // SESSION_ID=MKTG-0226</p>
