    ...
    const tabs = [
        {
            ...
            description: 'Identify where your market overlaps with competitors and new entrants.',
            bullets: ['Real-time territory mapping', 'Non-obvious competitor discovery', 'Adjacency scoring']
        },
        {
            title: 'Benchmarking',
            description: 'Scale-to-zero data extraction for deep-dive competitor comparisons.',
            bullets: ['Margin & Growth variance', 'Talent drain alerts', 'IP landscape tracking']
        },
        {
            title: 'Strategy Swarm',
            description: 'Trigger multi-agent strategy telemetry for board-ready decision memos.',
        ...
        <section id="product-tour" className="py-32 overflow-hidden">
            <div className="max-w-7xl mx-auto px-6">
                <div className="text-center mb-20">
                    <h2 className="text-xs font-black uppercase tracking-[0.4em] text-blue-500 mb-4">Product Tour</h2>
                ...
                <div className="grid lg:grid-cols-5 gap-12 items-center">
                        ...
                        {tabs.map((tab, idx) => (
                            ...
                            >
                                ...
                                <ul className="space-y-2">
                                    {tab.bullets.map((b, i) => (
                                        <li key={i} className={`flex items-center gap-2 text-[10px] font-bold uppercase tracking-wider ${activeTab === idx ? 'text-blue-400' : 'text-slate-600'}`}>
                                            <div className={`w-1 h-1 rounded-full ${activeTab === idx ? 'bg-blue-400 shadow-[0_0_5px_blue]' : 'bg-slate-700'}`} />
                                            {b}
                                        </li>
                                    ))}
                                </ul>
                    ...
                    <div className="lg:col-span-3">
                        <div className="relative aspect-[4/3] bg-slate-900/50 rounded-[40px] border border-white/10 p-6 backdrop-blur shadow-2xl relative">
                            ...
                            <div className="h-full border border-white/5 rounded-[24px] bg-[#05070A] overflow-hidden flex flex-col p-8">
                                <div className="flex justify-between items-center mb-12">
                                    ...
                                    <div className="flex gap-2">
                                        ...
                                        <div className="w-12 h-6 bg-blue-500/20 rounded-lg" />
                                    </div>
                                </div>
